...
export const ShotScene: React.FC<Props> = ({shot, title}) => {
    ...
    <AbsoluteFill style={{backgroundColor: '#05070a', opacity}}>
      {shot.image_src ? (
        ...
        <AbsoluteFill style={{alignItems: 'center', justifyContent: 'center', color: 'white'}}>
          <div style={{fontSize: 54, fontWeight: 700}}>{shot.shot_id}</div>
          <div style={{fontSize: 28, marginTop: 16}}>Missing image</div>
        </AbsoluteFill>
      )}
      <div
        style={{
